...
public class DataModelService {
    ...
    public void fillIndexTags(final Map<String, Object> dataModel) throws Exception {
        ...
        try {
            for (int i = 0; i < 13; i++) {
                ...
                tag.put(Tag.TAG_URI, "ml");
                tag.put(Tag.TAG_ICON_PATH, "sym.jpg");
                tag.put(Tag.TAG_TITLE, "ML");
    ...
    private void fillSideTips(final Map<String, Object> dataModel) {
        ...
        tipsLabels.add("<img align=\"absmiddle\" alt=\"tada\" class=\"emoji\" src=\"" + Latkes.getStaticServePath() +
                "/emoji/graphics/tada.png\" title=\"tada\"> 您好， 欢迎加入AIQ技术社区");
        tipsLabels.add("<img align=\"absmiddle\" alt=\"sparkles\" class=\"emoji\" src=\"" + Latkes.getStaticServePath() +
                "/emoji/graphics/sparkles.png\" title=\"sparkles\"> 为社区助力！");
