            ...
            <#if ADLabel!="">
                <div class="module">
                    <div class="module-header">
                        <h2>
                        ${sponsorLabel}
                            <a href="https://www.6aiq.com/article/1460083956075" class="fn-right ft-13 ft-gray" target="_blank">${wantPutOnLabel}</a>
                        </h2>
                    </div>
            ...
            <script type="text/javascript">
                (function(){
                    var p = {
                        ...
                        desc:'${article.articlePreviewContent}', /*分享理由(风格应模拟用户对话),支持多分享语随机展现（使用|分隔）*/
                        title:'${article.articleTitle}', /*分享标题(可选)*/
                        summary:'', /*分享摘要(可选)*/
                        pics:'${article.articleAuthorThumbnailURL210}', /*分享图片(可选)*/
                        flash: '', /*视频地址(可选)*/
                        site:'', /*分享来源(可选) 如：QQ分享*/
                        style:'201',
                        width:32,
                    ...
                    document.write(['<a href="http://connect.qq.com/widget/shareqq/index.html?',s.join('&'),'" target="_blank">  <span class="tooltipped tooltipped-e" aria-label="share to QQ" data-type="wechat"><svg class="icon-qq"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#qq"></use></svg></span></a>'].join(''));
                })();
            </script>
