...
var Util = {
  ...
  initSearch: function (algoliaAppId, algoliaSearchKey, algoliaIndex) {
    ...
    $('#search').autocomplete({
      hint: false,
      templates: {
        footer: '<div class="fn-right fn-pointer" onclick="window.open(\'http://www.6aiq.com\')">'
        + '<span class="ft-gray">search &hearts; you want in AIQ </span>'
      }
    //   <img src="' + Label.staticServePath + '/images/services/algolia128x40.png" /> </div>
    }, [{
